...
* **Billboard Test**
  ...
  As a test, show your feature graphic to someone for 5 seconds then take it away. Can the user recall the purpose of the app? If not, simplify the content until the app's primary concept can be understood within 5 seconds.
